...
###Change working Directory to "UCI HAR Dataset" i.e. where data is present
###Uses plyr package ensure u have it downloaded on pc
###Tested on Windows 10 with R version 3.4.3 (2017-11-30) -- "Kite-Eating Tree"
